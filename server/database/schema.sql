...
VALUES
  ...
  ("CSS", "Le bug a pris la forme d'un boss ! tu vas pouvoir utiliser les compétences que tu viens d'apprendre pour le vaincre", "css", "", "boss-spawn",  "", "null", "null", "null", "null", 2),
  ...
  ("Javascript", "Le bug a pris la forme d'un boss ! tu vas pouvoir utiliser les compétences que tu viens d'apprendre pour le vaincre", "javascript", "", "boss-spawn",  "", "null", "null", "null", "null", 3),
  ...
  ("React", "Tu dois trouver la bonne réponse parmi les 4 propositions pour débloquer la suite", "Comment on appelle ça déjà ? des bracket ?", "{}", "quizz", "Quelle syntaxe est utilisée pour insérer du JavaScript dans du JSX ?", "<>", "()", "[]", "{}", 4),
  ...
  ("React", "Clique sur le bouton et tape directement la réponse", "ces Objets permettent de passer des données d’un composant parent à un composant enfant. Ils sont immuables et accessibles en argument dans un composant fonctionnel.", "props", "prompt", "Comment appelle-t-on les données passées d’un composant parent à un composant enfant en React ?", "null", "null", "null", "null", 4),
  ("React", "Le bug a pris la forme d'un boss ! tu vas pouvoir utiliser les compétences que tu viens d'apprendre pour le vaincre", "react", "", "boss-spawn",  "", "null", "null", "null", "null", 4),
  ...
  ("Node", "Clique sur le bouton et tape directement la réponse", "Ce gestionnaire de paquets est installé avec Node.js et permet d’installer des bibliothèques JavaScript.", "npm", "prompt", "Quel est le gestionnaire de paquets par défaut de Node.js ?", null, null, null, null, 5),
  ...
  ("Node", "Le bug a pris la forme d'un boss ! tu vas pouvoir utiliser les compétences que tu viens d'apprendre pour le vaincre", "node", "", "boss-spawn",  "", "null", "null", "null", "null", 5),
  ...
  ("SQL", "Tu dois trouver la bonne réponse parmi les 4 propositions pour débloquer la suite", "Cette commande est utilisée pour extraire des données d'une table en SQL.", "NOT NULL", "quizz", "Quelle contrainte SQL empêche qu'une colonne contienne des valeurs nulles ?", "DEFAULT", "PRIMARY KEY", "NOT NULL", "UNIQUE", 6),
